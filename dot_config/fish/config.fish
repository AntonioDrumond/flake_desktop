if status is-interactive
    ...
    alias rebSwitch='sudo nixos-rebuild switch --flake ~/repos/flake_desktop/#nixos'
    alias rebBoot='sudo nixos-rebuild boot --flake ~/repos/flake_desktop/#nixos'
    alias rebTest='sudo nixos-rebuild test --flake ~/repos/flake_desktop/#nixos'
